...
public class SJFScheduler {
    ...
    public static void sjfScheduling(Process[] processes) {
        ...
        // Sort processes based on burst time, then by arrival time
        Arrays.sort(processes, Comparator.comparingInt((Process p) -> p.burstTime).thenComparingInt(p -> p.arrivalTime));
